    ...
    return Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child: MaterialButton(
            ...
            child: Text("Save Changes".tr, style: Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.primaryColor))),
            elevation: 0,
            ...
            children: [
             ...
             //  }),
              ...
              Padding(
                ...
                child: Text("Name" , style: Get.textTheme.subtitle2.copyWith(fontSize: 16)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text("Email", style: Get.textTheme.subtitle2.copyWith(fontSize: 16)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text("Mobile", style: Get.textTheme.subtitle2.copyWith(fontSize: 16)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text("Password", style: Get.textTheme.subtitle2.copyWith(fontSize: 16)),
              ),
