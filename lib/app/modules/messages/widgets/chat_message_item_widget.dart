                ...
                new Flexible(
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(chat.text, style: Get.textTheme.bodyText1),
                      Text(
                        DateFormat('HH:mm a', Get.locale.toString()).format(
                ...
                new Flexible(
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        DateFormat('HH:mm a', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.chat.time)),
                        overflow: TextOverflow.fade,
                        softWrap: false,
                        style: Get.textTheme.caption,
                      ),
