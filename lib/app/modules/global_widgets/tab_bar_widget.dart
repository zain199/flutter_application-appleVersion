  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return RawChip(
        elevation: 0,
        label: Text(text),
        labelStyle: controller.isSelected(this.id) ? Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.primaryColor)) : Get.textTheme.bodyText2.copyWith(color: Get.theme.colorScheme.secondary),
        padding: EdgeInsets.symmetric(horizontal: 15, vertical: 15),
        backgroundColor: Get.theme.colorScheme.secondary.withOpacity(0.08),
        selectedColor: Get.theme.colorScheme.secondary,
