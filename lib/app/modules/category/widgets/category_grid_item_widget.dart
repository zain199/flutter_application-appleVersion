...
import '../views/sub_category_view.dart';
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        ...
        //Get.to(SubCategoryView , arguments: category);
        if(category.subCategories.length > 0)
        Navigator.push(context, MaterialPageRoute(builder: (ctx) => SubCategoryView(category)));
      },
      child: Container(
        height: 170,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if ((category.subCategories?.length ?? 0) > 0)
                    Text('(${category.subCategories.length})',
                    textAlign: TextAlign.center,
